...
import useParcelamento from '@/data/useParcelamento';
...
export default function BannerCompra(props: BannerCompraProps){
    ...
    return (
        <div className='flex'>
            <div className='flex flex-col border-r border-zinc-5000 pr-5'>
            ...
            <div className='flex-1 flex flex-col tex-2xl font-semibold text-zinc-400 pl-5'>
