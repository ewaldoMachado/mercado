    ...
    return(
        <footer className='flex flex-col bg-black/30 text-zinc-400 mt-10'>
            ...
            <div className='container flex flex-col py-10 gap-10'>
                <div className='flex flex-col md:flex-row items-center md:items-start justify-between text-center md:text-left gap-5md:gap-0'>
                    <Logo/>
                    <div className='flex flex-col gap-1'>
                        <span className='text-2xl font-bold text-zinc-200 pb-2'>Sobre</span>
                        <span className='text-sm'>Nossa História</span>

                        <span className='text-sm'>Política de Privaciade</span>
                        <span className='text-sm'>Termos de Uso</span>

                    </div>
                    <div className='flex flex-col gap-1'>
                        <span className='text-2xl font-bold text-zinc-200 pb-2'>Contato: (86)91111-1111</span>
                        <span className='text-sm'>Suporte: Suporte@suporte</span>
